...
export default function ServicesHero() {
  ...
  return (
    <section data-testid="services-hero" style={{ position: "relative", overflow: "hidden", background: "var(--bg-page)", paddingTop: "7rem" }}>
      <div style={{
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: "1280px", margin: "0 auto", padding: "0 1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "2.5rem", animation: "fadeUp 0.5s ease 0.1s both" }}>
          ...
          <span className="font-mono" style={{ fontSize: "0.6rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--gold)" }}>Services</span>
        </div>
        ...
        <div className="about-hero-grid">
          <h1 className="font-display about-hero-h1" style={{ fontWeight: 300, lineHeight: 1.05, color: "var(--text-primary)", animation: "fadeUp 0.7s ease 0.35s both" }}>
            Complete,
            <br />
            <em style={{ color: "var(--gold)", fontStyle: "italic" }}>flexible</em>
            <br />
            solutions.
          </h1>
          <div style={{ animation: "fadeUp 0.7s ease 0.5s both" }}>
            ...
            <p className="font-body" style={{ color: "var(--text-secondary)", fontSize: "clamp(0.95rem, 1.6vw, 1.08rem)", lineHeight: 1.85, fontWeight: 300 }}>
              At Evora Capital, we deliver more than services — we provide complete, flexible
              solutions designed to maximise the value, performance, and potential of your
              hospitality asset. Whether you require full operational oversight or targeted
              support, our approach is built around you.
            </p>
          </div>
        </div>
      </div>
